...
import {
  LayoutDashboard, Building2, Users, Shield, Flag,
  Settings, LogOut, Menu, X, Bell, BarChart3
} from 'lucide-react';
...
const sidebarItems = [
  ...
  { icon: Building2, label: 'Centers', path: '/admin/centers' },
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-border">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-display font-bold">AYUSH Admin</span>
          </Link>
          <button
            onClick={() => setSidebarOpen(false)}
